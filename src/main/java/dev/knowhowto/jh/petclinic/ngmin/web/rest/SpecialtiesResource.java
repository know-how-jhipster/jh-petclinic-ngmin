...
import dev.knowhowto.jh.petclinic.ngmin.repository.SpecialtiesRepository;
import dev.knowhowto.jh.petclinic.ngmin.service.SpecialtiesService;
import dev.knowhowto.jh.petclinic.ngmin.service.dto.SpecialtiesDTO;
import dev.knowhowto.jh.petclinic.ngmin.web.rest.errors.BadRequestAlertException;
import tech.jhipster.web.util.HeaderUtil;
import tech.jhipster.web.util.ResponseUtil;

/**
 * REST controller for managing {@link dev.knowhowto.jh.petclinic.ngmin.domain.Specialties}.
 */
@RestController
@RequestMapping("/api")
