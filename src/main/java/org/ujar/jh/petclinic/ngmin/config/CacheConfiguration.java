package org.ujar.jh.petclinic.ngmin.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, org.ujar.jh.petclinic.ngmin.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, org.ujar.jh.petclinic.ngmin.repository.UserRepository.USERS_BY_EMAIL_CACHE);
