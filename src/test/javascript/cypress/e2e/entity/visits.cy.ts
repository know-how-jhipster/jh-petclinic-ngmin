...
describe('Visits e2e test', () => {
  ...
  const visitsSample = { visitdate: '2023-02-01T09:12:15.616Z', description: 'Assurance' };
  ...
  describe('new Visits page', () => {
    ...
    it('should create an instance of Visits', () => {
      cy.get(`[data-cy="visitdate"]`).type('2023-01-31T21:02').blur().should('have.value', '2023-01-31T21:02');
